...
function preselect(p_key,c_key,a_key){
   ...
   var cnt = provinces.length;
    ...
    //市
    var citys = dsy.Items['0_'+index];
    var cit = citys.length;
    for (i = 0; i < cit; i++) {
        if (c_key == citys[i]) {
            index2 = i;
            break;
    ...
    //区
    var areas = dsy.Items['0_'+index+'_'+index2];
    var aret = areas.length;
    for (i = 0; i < aret; i++) {
        if (a_key == areas[i]) {
            index3 = i;
            break;
    ...
    if (index2 < citys.length) {
        document.getElementById(s[1]).selectedIndex = index2 + 1;
        change(2);
    }
    if (index3 < areas.length) {
        document.getElementById(s[2]).selectedIndex = index3 + 1;
    }
}
