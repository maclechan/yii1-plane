    ...
    <div class="main">
     ...
     <div class="search">
        <!-- <ul class="searchSub">
         ...
         <!-- 收件箱  发件箱 -->
         <ul class="searchSub">
          <li><a href="<?php echo $this->createUrl('/admin/site/handle/messagelist');?>" class="red b_add">收件箱</a></li>
        	<li><a style="background:#cccccc;" href="<?php echo $this->createUrl('/admin/site/handle/messagesendlist');?>" class="red b_add">发件箱</a></li>
        </ul>
         ...
         <form action="<?php echo $this->createUrl('/admin/site/handle/messagesearch'); ?>" method="get" name="search" />
     ...
     <table id="sample2" width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr id="tr<?php echo $val->id?>">
            ...
            <td><a href="<?php echo $this->createUrl('navadd',array('id'=>$val->id));?>" class="Blue"></a><a href="<?php echo '/admin/site/handle/messagedel/id/'.$val->id;?>" class="sel" onclick="return confirm('确定删除？')">删除</a>
        </td>
        </tr>
		<?php }}?>
      </table>
