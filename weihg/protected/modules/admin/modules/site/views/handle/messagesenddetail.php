...
<div class="main">	
     <div class="tab">
     <div class="tabLeft">当前位置：<a href="javascript:void(0);" class="ccc_color">系统管理</a> > <a href="javascript:void(0);" class="ccc_color">私信管理</a> > <a href="<?php echo $this->createUrl('index')?>>" class="ccc_color">私信内容</a> > <a href="<?php echo $this->createUrl('navadd');?>" class="ccc_color">私信内容</a></div>
     </div>
  <div class="def_con">
