...
<title>待审核推荐产品</title>
    ...
    <script type="text/javascript" src="<?php echo Yii::app()->homeUrl;?>js/recommend.js"></script>
...
<nav class="navbar navbar-default navbar-static-top" role="navigation">
  <div class="container">
    <form method="get" action="<?php echo $this->createUrl('unsearch');?>" class="navbar-form navbar-right" role="search">
