...
<script data-main="<?php echo Yii::app()->homeUrl;?>js/crop/guwenadd" type="text/javascript" src="<?php echo Yii::app()->homeUrl;?>js/crop/require.min.js"></script>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $form->error($list,'name',array('class'=>'errorMessage glyphicon glyphicon-exclamation-sign'));?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                        <input type="hidden" id="hide-cuted" name="Adviser[icon]" class="form-control">
                    ...
                    <td><?php echo $form->error($list,'icon',array('class'=>'errorMessage glyphicon glyphicon-exclamation-sign'));?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><?php echo $form->error($list,'mobile',array('class'=>'errorMessage glyphicon glyphicon-exclamation-sign'));?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><?php echo $form->error($list,'weixin',array('class'=>'errorMessage glyphicon glyphicon-exclamation-sign'));?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><?php echo $form->textArea($list,'intro',array('style'=>'width:400px;height:300px;','class'=>'form-control','rows'=>'5','placeholder'=>"简介 255个字以内"));?></td>
                    <td></td>
                  </tr>
                  <tr>
                    <td></td>
