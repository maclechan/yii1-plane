              ...
              <table class="table">             
                <tbody>
                  <tr>
                    ...
                    <td><input type="text" readonly="" placeholder="<?php echo $list->id;?>" class="form-control"></td>
                    <td></td>
                  </tr>
                  <tr>
                    <td class="whg-text-right"><?php echo $form->label($list,'advi_name');?>：</td>
                    <td><input type="text" readonly="" placeholder="<?php echo $list->advi_name;?>" class="form-control"></td>
                    <td></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                        <input type="hidden" id="hide-cuted" name="AdviserAnli[cover]" value="<?php echo $list->cover;?>" class="form-control">
