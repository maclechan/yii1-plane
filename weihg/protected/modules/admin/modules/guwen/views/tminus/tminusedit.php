...
<script data-main="<?php echo Yii::app()->homeUrl;?>js/crop/tminus" type="text/javascript" src="<?php echo Yii::app()->homeUrl;?>js/crop/require.min.js"></script>
    ...
    <p></p>
            <div class="panel panel-default">
              ...
              <table class="table">             
                <tbody>
                  <tr>
                    <td class="whg-text-right">所属模块：</td>
                    <td>
                         <select class="form-control" name="Tminus[cid]">
                            <?php
                                foreach ($tcate as $k => $v) {
                             ?>
                            <option value="<?php echo $v->id; ?>" <?php if(isset($list)){echo ($v->id==$list->cid)?'selected':'';}?>><?php echo $v->cname; ?></option>
                            <?php } ?>
                        </select>
                    </td>
                    <td></td>
                  ...
                  <tr>
                    ...
                    <td>
                        <input type="hidden" id="hide-cuted" name="Tminus[cover]" value="<?php echo $list->cover;?>" class="form-control">
                        ...
                        <img id="image-cutshow" width="50" src="<?php echo $list->cover;?>" class="img-circle" alt="">
                        
                    </td>
                    <td><?php echo $form->error($list,'cover',array('class'=>'errorMessage glyphicon glyphicon-exclamation-sign'));?></td>
                  </tr>
                   <tr>
                    <td class="whg-text-right"><?php echo $form->labelEx($list,'browse');?>：</td>
                    <td><?php echo $form->textField($list,'browse',array("class"=>"form-control"))?></td>
                    <td></td>
                  </tr>
                   <tr>
                    <td class="whg-text-right"><?php echo $form->labelEx($list,'like');?>：</td>
                    <td><?php echo $form->textField($list,'like',array("class"=>"form-control"))?></td>
                    <td></td>
                  </tr>
                  <tr>
                    <td class="whg-text-right"><?php echo $form->label($list,'intro');?>：</td>
                    <td><?php echo $form->textArea($list,'intro',array('style'=>'width:400px;;','class'=>'form-control','rows'=>'4','placeholder'=>"简介 60个字以内"));?></td>
            ...
            <div class="col-xs-3">
                ...
                <div id="upload-wrap" style="margin-top:40px;">
                    ...
                    <div class="col-xs-12" id="ratio-wrap" style="margin-top:30px;display:none;">
                        ...
                        <span id="cut-help" class="help-block">输入宽高比进行裁剪初始化。例如1.1</span>
                        <p>
