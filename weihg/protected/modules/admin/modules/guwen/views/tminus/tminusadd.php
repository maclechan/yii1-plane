              ...
              <table class="table">             
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $form->textField($list,'title',array("class"=>"form-control","placeholder"=>"文章标题"))?></td>
                  ...
                  <tr>
                    ...
                    <td>
                        <input type="hidden" id="hide-cuted" name="Tminus[cover]" class="form-control">
