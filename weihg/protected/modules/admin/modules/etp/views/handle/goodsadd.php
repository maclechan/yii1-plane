...
<div class="whg-admin-wrap">
		...
		<form name="form1" class="form-inline" method="post" action="<?php echo $this->createUrl('etpgoodsadd')?>" enctype="multipart/form-data" onsubmit="return check_submit()">
		<table class="table">
      		<tbody>			
      			<tr>
			    	<td>产品名称<font color="red">&nbsp;*</font></td>
			    	<td><input type="text" name="goodname" id="goodname" class="form-control" /><font color="gray">&nbsp;&nbsp;(限制120个字符内)</font></td>
			    </tr>
			    <tr>
			    	<td>商家名称<font color="red">&nbsp;*</font></td>
			    	<td><input type="text" name="shangjia" id="shangjia" class="form-control" /><font color="gray">&nbsp;&nbsp;(输入产品的商家名)</font></td>
			    </tr>
			    <tr>
			    	<td>线下地址</td>
			    	<td><input type="text" name="s_location" id="s_location" class="form-control" /></td>
			    </tr>
			    <tr>
			    	<td>简介</td>
			    ...
			    <tr>
			    	...
			    	<td><input type="text" name="price" id="price" class="form-control" /><font color="gray">&nbsp;&nbsp;(限制20个字符内,格式:2400)</font></td>
			    </tr>
			    <tr>
			    	<td>商城优惠价<font color="red">&nbsp;*</font></td>
			    	<td><input type="text" name="shop_price" id="shop_price" class="form-control" /><font color="gray">&nbsp;&nbsp;(限制20个字符内,格式:2400)</font></td>
			    </tr>
			    <tr>
			    ...
			    <tr>
					...
					<input type="hidden" id="hide-cuted" name="icon" class="form-control">
