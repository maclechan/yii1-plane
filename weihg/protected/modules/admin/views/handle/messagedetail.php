...
<div class="main">	
     <div class="tab">
     <div class="tabLeft">当前位置：<a href="javascript:void(0);" class="ccc_color">系统管理</a> > <a href="javascript:void(0);" class="ccc_color">私信管理</a> > <a href="javascript:void(0);" class="ccc_color">私信内容</a></div>
     </div>
     <div class="shops_add">
  <div class="def_con">
     ...
     <div class="def_conD m10">
		<?php if($type == 1){?>
        <div class="def_achild next"><a href="/admin/handle/messageadd/sender_id/<?php echo $message->sender_id;?>" class="lan">回复私信</a></div>
		<?php }?>
