...
<div class="login">
	<!--输入部分-->
	<form id="login-form" class="form-signin" method="post" action="/manage/handle/sign.html" onsubmit="return checkform()">
		<input id="username" class="inputText input-block-level" placeholder="顾问登陆名" type="text" name="LoginForms[name]">
		...
		<?php 
			...
			<button class="btn btn-large btn-primary" type="submit">顾问登陆</button>
